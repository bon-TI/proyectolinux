function init(){
  ...
  element19 = document.getElementById('pdfviewer19');
...
/* PDF VIEWER 9*/  
function mostrarPdf9() {
  element9 = document.getElementById('pdfviewer9');
  estado9 = element9.style.display;
  if (estado9 == 'none') {
    element9.style.display = 'inline-block';
    element1.style.display = 'none';
    element2.style.display = 'none';
    element3.style.display = 'none';
    element4.style.display = 'none';
...
/* PDF VIEWER 10*/  
function mostrarPdf10() {
  element10 = document.getElementById('pdfviewer10');
  estado10 = element10.style.display;
  if (estado10 == 'none') {
    element10.style.display = 'inline-block';
    element1.style.display = 'none';
    element2.style.display = 'none';
    element3.style.display = 'none';
    element4.style.display = 'none';
...
function mostrarPdf12() {
  ...
  estado12 = element12.style.display;
  if (estado12 == 'none') {
    element12.style.display = 'inline-block';
    element1.style.display = 'none';
    element2.style.display = 'none';
    element3.style.display = 'none';
    element4.style.display = 'none';
...
/* PDF VIEWER 19*/  
function mostrarPdf19() {
  element19 = document.getElementById('pdfviewer19');
  estado19 = element19.style.display;
  if (estado19 == 'none') {
    element19.style.display = 'inline-block';
    element1.style.display = 'none';
    element2.style.display = 'none';
    element3.style.display = 'none';
    element4.style.display = 'none';
...
/* PDF VIEWER 20*/  
function mostrarPdf20() {
  element20 = document.getElementById('pdfviewer20');
  estado20 = element20.style.display;
  if (estado20 == 'none') {
    element20.style.display = 'inline-block';
    element1.style.display = 'none';
    element2.style.display = 'none';
    element3.style.display = 'none';
    element4.style.display = 'none';
